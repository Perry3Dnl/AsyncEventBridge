...
For the stable termination/ownership rules, see the [1.0 cancellation, lifecycle, and cleanup contract](docs/1.0-cancellation-lifecycle-cleanup.md).
...
AsyncEventBridge is licensed under the **MIT License**. See [`LICENSE`](LICENSE).
