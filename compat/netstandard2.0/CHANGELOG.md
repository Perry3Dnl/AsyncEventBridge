...
- Keep inactive event-backed sources genuinely unsubscribed in state-driven composition without changing the established public `TakeUntil` source/disposal contract.
