...
public sealed class AsyncEventBridgeGeneratorTests
{
    ...
    public void GeneratesAsyncMethodsForSupportedEvents()
    {
        ...
        Assert.Contains("/// <summary>Asynchronously waits for the next ValueChanged event occurrence.</summary>", generatedSource, StringComparison.Ordinal);
        Assert.Contains("/// <summary>Creates an async stream for ValueChanged event occurrences.</summary>", generatedSource, StringComparison.Ordinal);
