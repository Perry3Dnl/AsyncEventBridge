...
{
    /// <summary>
    /// Writes the subscriber exception through <see cref="System.Diagnostics.Trace"/> and continues dispatching.
    /// </summary>
    TraceAndContinue = 0,
...
internal readonly struct EventHandlerDispatchSettings
{
    ...
    internal static EventHandlerDispatchSettings Default { get; } =
        new EventHandlerDispatchSettings(EventBridgeSubscriberExceptionPolicy.TraceAndContinue, null);
}
}
